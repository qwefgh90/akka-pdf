 ...
 */
public class PDFUtilWrapper
{
    private static final Log LOG = LogFactory.getLog(PDFUtilWrapper.class);
     ...
     */
    public static InputStream merge(final List<InputStream> sources) throws IOException{
        return merge(sources, "", "", "");
    }
    public static InputStream merge(final List<InputStream> sources, String _title, String _creator, String _subject) throws IOException
    {
    ...
    private static PDFMergerUtility createPDFMergerUtility(List<InputStream> sources, ByteArrayOutputStream mergedPDFOutputStream)
    {
